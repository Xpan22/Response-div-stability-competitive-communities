...
## safe tests for causality
#save(rep_CCM,file="/Users/pegroup/Desktop/Til/Data analysis/rep_CCM.RData")
...
if(nrow(significant_pairwise_ccm_df)>=1){
  ...
  pred<-c("1 26","28 53", "55 80")
   ...
   sss<-lapply(pred,function(p){
      ...
      best_theta<-PredictNonlinear(dataFrame=dftemp,E=length(r$interactor),target=unique(r$target),columns=r$interactor,lib=lib,pred=p,embedded=T)
