...
```{r}
mixed_M_int<-lmer(data=int_aggr%>%dplyr::filter(theta%in%c("none","var")),log10(stability)~log10(imbalance_f)+nutrients+temperature+as.numeric(richness)+mean_interaction+(1|rep_var))
```
